...
class CameraPluginActivity : UnityPlayerActivity() {
    ...
    companion object {
        ...
        init {
            Log.d(TAG, "======= LOADING NATIVE A =======")
            System.loadLibrary("NativeCameraPlugin")
            Log.d(TAG, "======= LOADING NATIVE B =======")
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LogD("------------------------- [o] ACTIVITYY ON CREATE B")

        nativeInit()
        renderScript = RenderScript.create(this)
        LogD("------------------------- [o] ACTIVITYY ON CREATE C")
    }

    override fun onPause() {
        LogD("------------------------- [o] ACTIVITYY ON PAUSE A")
        ...
        stopCamera()
        super.onPause()
        LogD("------------------------- [o] ACTIVITYY ON PAUSE B")
    }

    override fun onResume() {
        LogD("------------------------- [o] ACTIVITYY ON RESUME A")
        super.onResume()
        handlerThread = HandlerThread(TAG)
        handlerThread?.start()
        startCamera()
        LogD("------------------------- [o] ACTIVITYY ON RESUME B")
    }

    override fun onDestroy() {
        LogD("------------------------- [o] ACTIVITYY ON DESTROY A")
        super.onDestroy()
        nativeRelease()
        INSTANCE = null
        LogD("------------------------- [o] ACTIVITYY ON DESTROY B")
    }
